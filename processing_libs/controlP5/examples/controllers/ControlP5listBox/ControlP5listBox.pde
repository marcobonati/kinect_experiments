...
void setup() {
  ...
  l = cp5.addListBox("myList")
         ...
         .setItemHeight(15)
         .setBarHeight(15)
         .setColorBackground(_color(255, 128))
         .setColorActive(_color(0))
         .setColorForeground(_color(255, 100,0))
         ;
  ...
  for (int i=0;i<80;i++) {
    l.addItem("item "+i, i);
    l.getItem("item "+i).put("_color", new CColor().setBackground(0xffff0000).setBackground(0xffff8800));
  }
...
void keyPressed() {
  ...
  if (key=='1') {
    ...
    // set the height of a listBoxItem, should always be a fraction of the listBox
    l.setItemHeight(10);
    l.setBackgroundColor(_color(100, 0, 0));
  } 
  else if (key=='a') {
