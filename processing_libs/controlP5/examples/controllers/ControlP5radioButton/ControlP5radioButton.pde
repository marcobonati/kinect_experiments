...
void setup() {
  ...
  r1 = cp5.addRadioButton("radioButton")
         .setPosition(100,180)
         .setSize(40,20)
         .setColorForeground(_color(120))
         .setColorActive(_color(255))
     ...
     for(Toggle t:r1.getItems()) {
       t.getCaptionLabel().setColorBackground(_color(255,80));
...
void controlEvent(ControlEvent theEvent) {
  if(theEvent.isFrom(r1)) {
    ...
    myColorBackground = _color(int(theEvent.getGroup().getValue()*50),0,0);
  }
}
